...
<div>
    ...
    <div class="container" align="center">
        <form action="" method="POST">
            <input type="number" class="btn" name="id"style="font-size:18px;height:30px;width:280px;" placeholder="Enter Doctor-Id">
        ...
        <br>
            ...
            <?php
                while($row=mysqli_fetch_assoc($query_run)){
                    ...
                    <td><a href='doctorupdate.php?id1=$row[DOCTORID]'><input type='submit' value='UPDATE'class='update'</a><a href='doctordelete.php?id1=$row[DOCTORID]'><input type='submit' value='DELETE'class='update' onclick='return checkdelete()'</a></td>
                </tr>
                ";
                }
            }
