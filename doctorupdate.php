...
<div>
        <nav class="navbar">
            <ul>
                <li><a href="doctordata.php"><i class="fa fa-backward" aria-hidden="true"></i><b>Back</b></a></li>
            </ul>
        </nav>
    </div>
    <div class="center">
        ...
        <table border="0" align="center" cellspacing="15">
            ...
            <tr>
                ...
                <td><input type="radio" style="font-size:18px;height:20px;width:50px" placeholder="Select Your Gender" name="r1" required value="Male" <?php
                                                                                                                                                        ...
                                                                                                                                                        ?>>Male<br><input type="radio" name="r1" style="font-size:18px;height:20px;width:50px" placeholder="Select Your Gender" value="Female" required<?php
                                                                                                                                                                if ($row['GENDER'] == 'Female') {
                                                                                                                                                                    echo "checked";
                                                                                                                                                                }
                                                                                                                                                                ?>>Female<br><input type="radio" style="font-size:18px;height:20px;width:50px" name="r1" placeholder="Select Your Gender" value="Other" required <?php
                                                                                                                                                                    if ($row['GENDER'] == 'Other') {
                                                                                                                                                                        echo "checked";
                                                                                                                                                                    }
                                                                                                                                                                    ?>>Other
            ...
            <tr>
                <td><b>
                        Doctor-Id:</b>
                <td> <input type="number" style="font-size:18px;height:30px;width:280px" placeholder="Enter Your Aadhar number" required name="doctorId" value="<?php echo $row['DOCTORID']; ?>"></td>
            </tr>
            <tr>
                <td><b>
                        Date of Birth:</b>
            ...
            <tr>
             ...
             <tr>
                <td><b>
                        Specialization:</b>
                <td> <input type="text" style="font-size:18px;height:30px;width:280px" placeholder="Enter Your Specialization" required name="specialization" value="<?php echo $row['SPECIALIZATION']; ?>"></td>
            </tr> 
            <tr>
...
$query="UPDATE doctor SET FIRSTNAME='$fname',LASTNAME='$lname',GENDER='$r1',DOCTORID='$doctorId',DOB='$dob',LOCATION='$location',PHONE='$phone',SPECIALIZATION='$specialization' WHERE DOCTORID='$id'";
