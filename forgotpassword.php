...
if(isset($_POST["submit"]))
{
  ...
  $query="SELECT * FROM register where EMAIL='$email' AND COLOR='$color'";
  ...
  <div>
    ...
    <div class="center">
      ...
      <form method="post">
        ...
        <div class="txt_field">
            <input type="password" required name="password"pattern="\w\w\w\w\w\w\w\w+" placeholder="Enter minimum 8-digit new password">
          </div>
            <span></span>
